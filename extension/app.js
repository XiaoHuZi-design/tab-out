...
/* ----------------------------------------------------------------
   CLOCK — live time display in header
   ---------------------------------------------------------------- */
...
/* ----------------------------------------------------------------
   SEARCH BAR — Google search or URL navigation
   ---------------------------------------------------------------- */
...
/* ----------------------------------------------------------------
   DARK MODE — toggle + persist in chrome.storage.local
   ---------------------------------------------------------------- */
...
/* ----------------------------------------------------------------
   BACKGROUND THEME — color swatches + persist
   ---------------------------------------------------------------- */
async function initBgTheme() {
  ...
  const { bgTheme = 'paper' } = await chrome.storage.local.get('bgTheme');
  if (bgTheme !== 'paper') {
    document.body.classList.add('bg-' + bgTheme);
    popover.querySelectorAll('.theme-option').forEach(o =>
      o.classList.toggle('active', o.dataset.bg === bgTheme));
  }
  ...
  popover.querySelectorAll('.theme-option').forEach(opt => {
    opt.addEventListener('click', async (e) => {
      e.stopPropagation();
      document.body.className = opt.dataset.bg === 'paper' ? '' : 'bg-' + opt.dataset.bg;
      popover.querySelectorAll('.theme-option').forEach(o => o.classList.remove('active'));
      opt.classList.add('active');
      await chrome.storage.local.set({ bgTheme: opt.dataset.bg });
